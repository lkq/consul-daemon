...
public class BindAddress implements OptionBuilder {

    public static final String IPV4_PATTERN = "^[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}$";
    private static Logger logger = LoggerFactory.getLogger(BindAddress.class);

    private AWSClient awsClient;

    public BindAddress(AWSClient awsClient) {
    ...
    @Override
    public String build() {
        return "-advertise=" + getBindingAddress();
